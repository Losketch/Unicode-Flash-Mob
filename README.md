...
# Unicode-Flash-Mob（Unicode快闪视频生成）
...
[![License](https://img.shields.io/static/v1?label=使用协议&message=SIL%20Open%20Font%20License&color=critical&logo=creative%20commons)](https://githubfast.com/Losketch/Unicode-Flash-Mob/blob/main/LICENSE.txt)
</div>
