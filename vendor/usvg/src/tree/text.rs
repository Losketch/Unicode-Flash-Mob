...
/// An OpenType shaping feature setting.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Hash)]
pub struct FontFeature {
    /// The 4-byte OpenType feature tag (for example `b"liga"`).
    pub tag: [u8; 4],
    /// The feature value. Zero disables a feature and non-zero values enable it.
    pub value: u32,
}

impl FontFeature {
    /// Creates a new OpenType feature setting.
...
impl TextSpan {
    ...
    /// Arbitrary OpenType features forwarded to the shaping engine.
