def replace_content(temp_file, option):
    file_map = {
        ...
        '3': 'DecipherUnicodeMY1LBlocks.txt',
        '4': 'DecipherUnicodeLosketchBlocks.txt'
    }
